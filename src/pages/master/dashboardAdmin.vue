		...
		<ul class="side-menu top">
			...
			<li>
				<router-link to="/gestionPaciente" class="flex items-center">
					...
					<span style="margin-left: 8px;">Usuarios</span>
				</router-link>
			</li>
			<li>
				<router-link to="/gestionPaciente" class="flex items-center">
					<svg xmlns="http://www.w3.org/2000/svg" height="16" width="20" viewBox="0 0 640 512" class="mr-2">
						<path
			...
			<li>
				<router-link to="/gestionMedico" class="flex items-center">
					<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
						style="fill: rgba(0, 0, 0, 1);transform: ;msFilter:;" class="mr-2">
						<path
					...
					<span style="margin-left: 8px;">Médicos</span>
				</router-link>
			</li>
			<li>
				<router-link to="/gestionCita" class="flex items-center">
					<svg xmlns="http://www.w3.org/2000/svg" height="16" width="14" viewBox="0 0 448 512" class="mr-2">
						<path
					...
					<span style="margin-left: 8px;">Citas</span>
				</router-link>
			</li>
		</ul>
		<ul class="side-menu">
			<li>
				<router-link to="#" class="flex items-center">
					...
					<span style="margin-left: 8px;">Configuracion</span>
				</router-link>
			</li>
			<li>
				<router-link to="#" class="logout">
					<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
						style="fill: rgba(0, 0, 0, 1);transform: ;msFilter:;">
						<path
							d="M18 2H6a1 1 0 0 0-1 1v9l5-4v3h6v2h-6v3l-5-4v9a1 1 0 0 0 1 1h12a1 1 0 0 0 1-1V3a1 1 0 0 0-1-1z">
						</path>
					</svg>
...
#content main .table-data .order table tr td .edit-btn {
	font-size: 10px;
	padding: 6px 16px;
	color: var(--light);
	border-radius: 20px;
