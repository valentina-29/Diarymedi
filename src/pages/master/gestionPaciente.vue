        ...
        <div class="table-data">
          <div class="order">
            <div class="head">
              <h3>
                <li>
					<router-link to="/agregarPaciente">Añadir</router-link>
                </li>
              </h3>
            ...
            <table>
              ...
              <tbody>
                <tr class="editable-row">
                  <td contenteditable="true">1065789534</td>
                  <td contenteditable="true">John Doe</td>
                  <td contenteditable="true">jpcoteslibañes@gmail.com</td>
                  <td contenteditable="true">3115555555</td>
                  <td contenteditable="true">Contributivo</td>
                  <td>
                ...
                <tr>
                  ...
                  <td>jpcoteslibañes@gmail.com</td>
                  <td>3115555555</td>
                  <td>Beneficiario</td>
                  <td>
                    <input class="edit-btn" type="button" value="Editar" />
